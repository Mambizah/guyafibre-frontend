...
export default function DevisPage() {
  ...
  const canProceed = () => {
    switch (currentStep) {
      ...
      case 2:
        return formData.projectType && formData.address && formData.city
      case 3:
                        ...
                        <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                          <div className="flex items-center gap-3 mb-6">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-muted-foreground">Parlez-nous de votre projet</p>
                            </div>
                          </div>
                        ...
                        <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                          <div className="flex items-center gap-3 mb-6">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-muted-foreground">Décrivez votre besoin en détail</p>
                            </div>
                          </div>
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="space-y-4">
                      ...
                      >
                        ...
                        <div>
                          <div className="text-xs text-muted-foreground">Guyane (+594)</div>
                          <div className="font-semibold text-foreground">06 94 43 54 84</div>
                        </div>
                      </a>
                      <a 
