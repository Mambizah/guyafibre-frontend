      ...
      <div className="container-wide">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            {/* Founder card */}
            <div className="bg-card dark:bg-muted rounded-xl p-5 flex items-start gap-4 border border-border">
              ...
              <div>
                <div className="font-semibold text-foreground font-display">{getText("about.founderName")}</div>
                <div className="text-sm text-primary mb-2">{getText("about.founderRole")}</div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {strengths.map((s) => {
                ...
                return (
                  <div
                    key={s.titleKey}
                    className="group relative bg-card dark:bg-muted rounded-xl border border-border hover:border-primary/30 hover:shadow-lg transition-all duration-300 overflow-hidden"
                  >
                    {/* Image background */}
