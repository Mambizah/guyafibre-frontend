...
export function StatsSection() {
  ...
  const stats = [
    ...
    { value: 2018, suffix: "", labelKey: "stats.founded", descKey: "stats.foundedDesc" },
  ]
  ...
  const defaultLabels: Record<string, string> = {
    ...
    "stats.founded": "Année de fondation",
    "stats.foundedDesc": "Entreprise guyanaise",
  }
  ...
  return (
    <section id="stats" ref={ref} className="bg-card dark:bg-secondary border-y border-border">
