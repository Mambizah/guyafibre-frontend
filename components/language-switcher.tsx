    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button 
          variant="ghost" 
          size="sm" 
          className="gap-2 px-2.5 h-9 text-foreground/80 dark:text-white/80 hover:text-foreground dark:hover:text-white hover:bg-muted dark:hover:bg-white/10 border border-border dark:border-white/10 hover:border-border dark:hover:border-white/20"
        >
          <Image
            src={flagUrls[locale]}
